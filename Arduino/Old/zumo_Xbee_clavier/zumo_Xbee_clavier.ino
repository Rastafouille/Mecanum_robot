...
void loop()
{
 //COMMANDE CLAVIER    
  ...
  if (Serial.available()>0) {buffer=Serial.read();Serial.print("reception : "); Serial.println(buffer); }
  if (buffer==122) {motors.setLeftSpeed(vleft);motors.setRightSpeed(vright);} // touche z
  else if (buffer==115) {motors.setLeftSpeed(-vleft);motors.setRightSpeed(-vright);} // touche s
  else if (buffer==113) {motors.setLeftSpeed(-vleft);motors.setRightSpeed(vright);} // touche q
  else if (buffer==100) {motors.setLeftSpeed(vleft);motors.setRightSpeed(-vright);} // touche d
  else if (buffer==97) {motors.setLeftSpeed(0);motors.setRightSpeed(0);} // touche a
